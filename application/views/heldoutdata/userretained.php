...
<script type="text/javascript">
    ...
    function getfirstchartdata()
    {
        ...
        if(timephase=='any')
        {        
            myurl="<?php echo site_url()?>/report/userretained/Roleofretainedlist/"+timephase+"/"+fromCurTime+"/"+toCurTime+"/"+opdetailed;
        }
        else
        {
            myurl = "<?php echo site_url()?>/report/userretained/Roleofretainedlist/"+timephase+"/"+opdetailed;
        }
