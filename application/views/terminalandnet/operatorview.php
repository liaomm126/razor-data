<section id="main" class="column" style="height: 1100px">
    <div style="height:480px;">
        <iframe src="<?php echo site_url() ?>/report/operator/addcarrierreport" frameborder="0" scrolling="no"
...
<script type="text/javascript">
    ...
    function pageselectCallback(page_index, jq) {
        ...
        for (i = 0; i < pagenum && (index + i) < detailObj.length; i++) {
            msg = msg + "<tr><td>";
            if (detailObj[i + index].devicesupplier_name.length < 1)
                detailObj[i + index].devicesupplier_name = 'unknown';
