...
if (isset($add)) {
    ...
    <?php
} echo  lang('v_rpt_pb_overviewOfUserBehavior')?></h3>
            <ul class="tabs3">
                <li><a ct="newUser"
                    href="javascript:changeChartName('<?php echo  lang('t_newUsers')?>')"><?php echo  lang('t_newUsers')?></a></li>
                <li><a ct="totalUser"
                    href="javascript:changeChartName('<?php echo  lang('t_accumulatedUsers')?>')"><?php echo  lang('t_accumulatedUsers')?></a></li>
                <li><a ct="activeUser"
                    href="javascript:changeChartName('<?php echo  lang('t_activeUsers')?>')"><?php echo  lang('t_activeUsers')?></a></li>
                <li><a ct="startUser"
                    href="javascript:changeChartName('<?php echo  lang('t_sessions')?>')"><?php echo  lang('t_sessions')?></a></li>
                <li><a ct="averageUsingTime"
                    href="javascript:changeChartName('<?php echo  lang('t_averageUsageDuration')?>')"><?php echo  lang('t_averageUsageDuration')?></a></li>
            </ul>
        </header>
...
var avgUsage=[];
var avgUsagettrend=[];
var show_thrend='<?php if (isset($common)) {
    echo $common['show_thrend'];
} else {
    echo 1;
}?>';
var show_markevent='<?php if (isset($common)) {
    echo $common['show_markevent'];
} else {
    echo 1;
}?>';
var productNames=[];
