...
<script type="text/javascript">
    ...
    function getfirstchartdata()
    {
        ...
        if(timephase=='any')
        {        
myurl="<?php echo site_url()?>/report/heldoutdata/heldoutdatalist/"+timephase+"/"+fromCurTime+"/"+toCurTime+"/"+opdetailed;
        }
        else
        {
myurl = "<?php echo site_url()?>/report/heldoutdata/heldoutdatalist/"+timephase+"/"+opdetailed;
        }
